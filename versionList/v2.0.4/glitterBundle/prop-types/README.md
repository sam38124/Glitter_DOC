...
```js
import PropTypes from 'versionList/v2.0.3/glitterBundle/prop-types/prop-types'; // ES6
var PropTypes = require('versionList/v2.0.3/glitterBundle/prop-types/prop-types'); // ES5 with npm
```
