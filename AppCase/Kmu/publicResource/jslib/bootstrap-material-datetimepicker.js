(function ($, moment)
{
    ...
    function Plugin(element, options)
    {
        ...
        this.params = {date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'en', weekStart: 0, disabledDays: [], shortTime: false, clearButton: false, nowButton: false, cancelText: '取消', okText: '設定', clearText: '清除', nowText: '現在時間', switchOnClick: false, triggerEvent: 'focus', monthPicker: false, year:true};
