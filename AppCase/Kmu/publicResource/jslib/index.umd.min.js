...
!function (e, t) {
    ...
    var t = {
        ...
        instructionsPullToRefresh: "下拉更新",
        instructionsReleaseToRefresh: "放開更新",
    ...
    }, i = ["mainElement", "ptrElement", "triggerElement"], o = function (t) {
        var n = {};
    ...
    return {
        ...
        }, _: {setupHandler: o, setupEvents: s, setupDOM: t.setupDOM, onReset: t.onReset, update: t.update}
    }
});
