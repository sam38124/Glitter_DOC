var ListItem = createReactClass({
    ...
    <source src="${data.video}/root.m3u8" type="application/x-mpegURL" id="source">
        ...
        return <div id={`list-item${this.props.index}`}>
            ...
            <div className={`list_item`}>
                <div className={"headBar"} onMouseDown={
                    ...
                    {(glitter.publicBeans.publicLogic.customDefine.myFollow.filter(function (dd) {
                        ...
                        <h3 className={"follow"} onMouseDown={
                            function (e) {
                                ...
                                setTimeout(function () {that.preventClick = false}, 10)
                    ...
                    {(data.account === glitter.publicBeans.publicLogic.customDefine.user_data.account) ?
                        <img class={"more"} src={"../img/more.png"} onMouseDown={function (e) {
                            that.preventClick = true
                            setTimeout(function () {
            ...
            <div id={`slide` + this.props.index} className="single-item"
                 dangerouslySetInnerHTML={{__html: imageList}}></div>
            <div className={"flex"}>
                ...
                <span className={"message"} dangerouslySetInnerHTML={{__html: `${glitter.share.publicUI.message()}`}}
                      onClick={
                          function (e) {
...
">`
    ...
    componentDidMount: function () {
        var that = this
        if (this.props.index === 0 && this.props.adData.length > 0) {
