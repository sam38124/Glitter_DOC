...
var ArticleContent=createReactClass({
    render:function (){
            return  <div id={`Content`} className={"contentdiv"}>
                <div className="flexUser">
                    <img src={gBundle.head} className="img"></img>
                    <div className={"textContent"}>
                <span className={"artText"}>
                     <span className={"pick"}>{(gBundle.pick)}</span>
                    {(gBundle.content)}</span>
                    </div>
                </div>
                <span className={`time`}>{`${gBundle.time}`}</span>
            </div>
    },
